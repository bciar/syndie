    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    if ($model->wallet)
                    {return $model->wallet->id;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Wallet::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Wallet', 'id' => 'grid--wallet_id']
            ],
        [
                'attribute' => 'user_id',
                'label' => 'User',
